_24e‍.x([["default",()=>Game],["twoOrFour",()=>twoOrFour],["slideRight",()=>slideRight],["slideLeft",()=>slideLeft],["slideUp",()=>slideUp],["slideDown",()=>slideDown],["combineLeft",()=>combineLeft],["combineRight",()=>combineRight],["combineUp",()=>combineUp],["combineDown",()=>combineDown],["addRandom",()=>addRandom]]);/*
 ...
 */
  ...
  move(direction) {
    ...
    if (
      ...
      this.gameState.board.length != this.size * this.size
    ) {
      // if it didnt change
      let rand = addRandom(this.gameState.board, this.size);
      this.gameState.board = rand;
    }
    console.log(this.gameState.board.length);
...
let shuffle = function (array) {
  ...
  return array;
       ...
       let slideRight = function (board, size) {
  let newboard = [];
  ...
  return newboard;
       ...
       let slideLeft = function (board, size) {
  let newboard = [];
  for (let i = 0; i < size * size; i++) {
    // go through all the board
    if (i % size == 0) {
  ...
  return newboard;
       ...
       let slideUp = function (board, size) {
  let newboard = [];
  ...
  return transpose;
       ...
       let slideDown = function (board, size) {
  let newboard = [];
  for (let i = 0; i < size; i++) {
    // can look at all the columns by going over the first row
    let column = [];
  ...
  return transpose;
       ...
       let combineLeft = function (board, size, gameState) {
  let total = 0;
  let sum = 0;
  ...
  return [board, total];
       ...
       let combineRight = function (board, size, gameState) {
  let total = 0;
  let sum = 0;
  ...
  return [board, total];
       ...
       let combineUp = function (board, size, gameState) {
  let total = 0;
  let sum = 0;
  for (let i = 0; i < size * (size - 1); i++) {
    // one whole row won't have anything up/down
  ...
  return [board, total];
       ...
       let combineDown = function (board, size, gameState) {
  let total = 0;
  let sum = 0;
  let moved = false;
  ...
  return [board, total];
       ...
       let addRandom = function (board, size) {
  let ind = [];
  for (let i = 0; i < board.length; i++) {
    if (board[i] == 0) {
      ind.push(i);
